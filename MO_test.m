...
for i = 1:G_size
   ...
   if (save_simulation)
        ...
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G1_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G1_data = G_data; 
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G2_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G2_data = G_data; 
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G3_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G3_data = G_data; 
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G4_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G4_data = G_data; 
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G5_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G5_data = G_data; 
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G6_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G6_data = G_data; 
...
for j = 1:G_size
    for i = 1:G_size2
       ...
       if (save_simulation)
            gl_figure_counter = gl_figure_counter + 1;
            saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G7_',num2str(j),'_',num2str(i),'_MO.tiff')]);
            close;
       end
    end
end
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G8_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G8_data = G_data; 
...
for i = 1:G_size
   ...
   if (save_simulation)
        gl_figure_counter = gl_figure_counter + 1;
        saveas(figure_handler,[pwd strcat('/wykresy/sterowania/G9_',num2str(i),'_MO.tiff')]);
        close;
   end
end
G9_data = G_data; 
